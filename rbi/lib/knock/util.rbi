...
module Knock
  module Util
    ...
    class << self
      sig { params(url: T.any(URI::Generic, String)).returns(Knock::Util::ParsedUriShape) }
      def parse_uri(url)
      end

      sig { params(parsed: Knock::Util::ParsedUriShape).returns(URI::Generic) }
      def unparse_uri(parsed)
      end

      sig { params(lhs: Knock::Util::ParsedUriShape, rhs: Knock::Util::ParsedUriShape).returns(URI::Generic) }
    ...
    class << self
      ...
      sig { params(lines: T::Enumerable[String]).returns(Knock::Util::SSEMessage) }
