...
module Knock
  module Models
    class Message < Knock::BaseModel
      ...
      sig { returns(T.nilable(T::Array[T.any(String, Knock::Models::Message::Actor::ObjectReference)])) }
      def actors
      end

      sig do
        params(_: T::Array[T.any(String, Knock::Models::Message::Actor::ObjectReference)])
          .returns(T::Array[T.any(String, Knock::Models::Message::Actor::ObjectReference)])
      end
      def actors=(_)
      end
      ...
      sig { returns(T.nilable(T.any(String, Knock::Models::Message::Recipient::ObjectReference))) }
      def recipient
      end

      sig do
        params(_: T.any(String, Knock::Models::Message::Recipient::ObjectReference))
          .returns(T.any(String, Knock::Models::Message::Recipient::ObjectReference))
      end
      def recipient=(_)
      end
      ...
      sig { returns(T.nilable(Knock::Models::Message::Source)) }
      def source
      end

      sig { params(_: Knock::Models::Message::Source).returns(Knock::Models::Message::Source) }
      def source=(_)
      end
      ...
      sig do
        params(
          id: String,
          _typename: String,
          actors: T::Array[T.any(String, Knock::Models::Message::Actor::ObjectReference)],
          ...
          recipient: T.any(String, Knock::Models::Message::Recipient::ObjectReference),
      ...
      class Actor < Knock::Union
        ...
        class << self
          sig { override.returns([[NilClass, String], [NilClass, Knock::Models::Message::Actor::ObjectReference]]) }
      ...
      class Recipient < Knock::Union
        ...
        class << self
          sig { override.returns([[NilClass, String], [NilClass, Knock::Models::Message::Recipient::ObjectReference]]) }
          private def variants
          end
        end
      end
