...
module Knock
  module Models
    class PreferenceSet < Knock::BaseModel
      ...
      sig do
        returns(
          T.nilable(
            T::Hash[
            Symbol,
            T.any(T::Boolean, Knock::Models::PreferenceSet::Category::PreferenceSetWorkflowCategorySettingObject)
            ]
          )
        )
      end
      ...
      sig do
        returns(
          T.nilable(
            T::Hash[
            Symbol,
            T.any(T::Boolean, Knock::Models::PreferenceSet::Workflow::PreferenceSetWorkflowCategorySettingObject)
            ]
          )
        )
      end
      ...
      def initialize(id:, _typename:, categories: nil, channel_types: nil, workflows: nil)
      end
      ...
      class Category < Knock::Union
        ...
        class << self
          sig do
            override
              .returns(
                [[NilClass, T::Boolean], [NilClass, Knock::Models::PreferenceSet::Category::PreferenceSetWorkflowCategorySettingObject]]
              )
          end
      ...
      class Workflow < Knock::Union
        ...
        class << self
          sig do
            override
              .returns(
                [[NilClass, T::Boolean], [NilClass, Knock::Models::PreferenceSet::Workflow::PreferenceSetWorkflowCategorySettingObject]]
              )
          end
          private def variants
          end
