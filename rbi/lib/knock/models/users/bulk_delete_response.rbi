  ...
  module Models
    module Users
      class BulkDeleteResponse < Knock::BaseModel
        ...
        sig { returns(T.nilable(T::Array[Knock::Models::Users::BulkDeleteResponse::ErrorItem])) }
        def error_items
        end

        sig do
          params(_: T::Array[Knock::Models::Users::BulkDeleteResponse::ErrorItem])
            .returns(T::Array[Knock::Models::Users::BulkDeleteResponse::ErrorItem])
        end
        def error_items=(_)
        end
        ...
        sig do
          params(
            ...
            error_count: Integer,
            error_items: T::Array[Knock::Models::Users::BulkDeleteResponse::ErrorItem],
