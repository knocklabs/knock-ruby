  ...
  module Models
    module Users
      class FeedListItemsResponse < Knock::BaseModel
        ...
        sig { returns(T::Array[Knock::Models::Users::FeedListItemsResponse::Activity]) }
        def activities
        end

        sig do
          params(_: T::Array[Knock::Models::Users::FeedListItemsResponse::Activity])
            .returns(T::Array[Knock::Models::Users::FeedListItemsResponse::Activity])
        end
        def activities=(_)
        end
        ...
        sig do
          params(
            id: String,
            _typename: String,
            activities: T::Array[Knock::Models::Users::FeedListItemsResponse::Activity],
