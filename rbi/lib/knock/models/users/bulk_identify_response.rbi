  ...
  module Models
    module Users
      class BulkIdentifyResponse < Knock::BaseModel
        ...
        sig { returns(T.nilable(T::Array[Knock::Models::Users::BulkIdentifyResponse::ErrorItem])) }
        def error_items
        end

        sig do
          params(_: T::Array[Knock::Models::Users::BulkIdentifyResponse::ErrorItem])
            .returns(T::Array[Knock::Models::Users::BulkIdentifyResponse::ErrorItem])
        end
        def error_items=(_)
        end
        ...
        sig do
          params(
            ...
            error_count: Integer,
            error_items: T::Array[Knock::Models::Users::BulkIdentifyResponse::ErrorItem],
