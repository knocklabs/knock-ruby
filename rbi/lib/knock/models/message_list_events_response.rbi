...
module Knock
  module Models
    class MessageListEventsResponse < Knock::BaseModel
      ...
      sig { returns(T.any(String, Knock::Models::MessageListEventsResponse::Recipient::ObjectReference)) }
      def recipient
      end

      sig do
        params(_: T.any(String, Knock::Models::MessageListEventsResponse::Recipient::ObjectReference))
          .returns(T.any(String, Knock::Models::MessageListEventsResponse::Recipient::ObjectReference))
      end
      def recipient=(_)
      end
      ...
      sig do
        params(
          ...
          _typename: String,
          inserted_at: Time,
          recipient: T.any(String, Knock::Models::MessageListEventsResponse::Recipient::ObjectReference),
          type: Symbol,
      ...
      class Recipient < Knock::Union
        ...
        class << self
          sig do
            override
              .returns(
                [[NilClass, String], [NilClass, Knock::Models::MessageListEventsResponse::Recipient::ObjectReference]]
              )
          end
