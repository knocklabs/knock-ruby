  ...
  module Models
    module Tenants
      class BulkSetResponse < Knock::BaseModel
        ...
        sig { returns(T.nilable(T::Array[Knock::Models::Tenants::BulkSetResponse::ErrorItem])) }
        def error_items
        end

        sig do
          params(_: T::Array[Knock::Models::Tenants::BulkSetResponse::ErrorItem])
            .returns(T::Array[Knock::Models::Tenants::BulkSetResponse::ErrorItem])
        end
        def error_items=(_)
        end
        ...
        sig do
          params(
            ...
            error_count: Integer,
            error_items: T::Array[Knock::Models::Tenants::BulkSetResponse::ErrorItem],
