...
module Knock
  module Models
    class AudienceAddMembersParams < Knock::BaseModel
      extend Knock::RequestParameters::Converter
      include Knock::RequestParameters

      sig { returns(T::Array[Knock::Models::AudienceAddMembersParams::Member]) }
      def members
      end

      sig do
        params(_: T::Array[Knock::Models::AudienceAddMembersParams::Member])
          .returns(T::Array[Knock::Models::AudienceAddMembersParams::Member])
      end
      def members=(_)
      end
      ...
      sig do
        override
          .returns(
            {members: T::Array[Knock::Models::AudienceAddMembersParams::Member], request_options: Knock::RequestOptions}
          )
      end
      def to_hash
      end
