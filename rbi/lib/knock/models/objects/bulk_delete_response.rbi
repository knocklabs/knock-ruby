  ...
  module Models
    module Objects
      class BulkDeleteResponse < Knock::BaseModel
        ...
        sig { returns(T.nilable(T::Array[Knock::Models::Objects::BulkDeleteResponse::ErrorItem])) }
        def error_items
        end

        sig do
          params(_: T::Array[Knock::Models::Objects::BulkDeleteResponse::ErrorItem])
            .returns(T::Array[Knock::Models::Objects::BulkDeleteResponse::ErrorItem])
        end
        def error_items=(_)
        end
        ...
        sig do
          params(
            ...
            error_count: Integer,
            error_items: T::Array[Knock::Models::Objects::BulkDeleteResponse::ErrorItem],
