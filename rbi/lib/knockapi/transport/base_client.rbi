...
module Knockapi
  module Transport
    ...
    class BaseClient
        ...
        T.type_alias do
          {
            ...
            page: T.nilable(T::Class[Knockapi::Type::BasePage[Knockapi::BaseModel]]),
            stream: T.nilable(T::Class[T.anything]),
            model: T.nilable(Knockapi::Type::Converter::Input),
      ...
      class << self
        # @api private
        sig { params(req: Knockapi::Transport::BaseClient::RequestComponentsShape).void }
        def validate!(req)
        end
        ...
        sig do
          params(
            request: Knockapi::Transport::BaseClient::RequestInputShape,
            status: Integer,
            response_headers: T.any(T::Hash[String, String], Net::HTTPHeader)
          )
            .returns(Knockapi::Transport::BaseClient::RequestInputShape)
        end
      ...
      # @api private
      sig { returns(Knockapi::Transport::PooledNetRequester) }
      ...
      sig do
        overridable
          .params(req: Knockapi::Transport::BaseClient::RequestComponentsShape, opts: Knockapi::Util::AnyHash)
          .returns(Knockapi::Transport::BaseClient::RequestInputShape)
      end
