...
module Knockapi
  ...
  module Converter
    ...
    # @api private
    sig { overridable.params(value: T.anything, state: Knockapi::Converter::State).returns(T.anything) }
    ...
    class << self
      ...
      sig do
        params(target: Knockapi::Converter::Input, value: T.anything, state: Knockapi::Converter::State)
          .returns(T.anything)
      end
      def self.coerce(
        target,
  ...
  class Unknown
    ...
    class << self
      # @api private
      sig(:final) do
        override.params(value: T.anything, state: Knockapi::Converter::State).returns(T.anything)
      end
      def coerce(value, state:)
      end
  ...
  class BooleanModel
    ...
    class << self
      ...
      sig(:final) do
        override
          .params(value: T.any(T::Boolean, T.anything), state: Knockapi::Converter::State)
  ...
  module Enum
    ...
    sig do
      override
        .params(value: T.any(String, Symbol, T.anything), state: Knockapi::Converter::State)
  ...
  module Union
    ...
    sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Knockapi::Converter::Input)]]) }
    ...
    # @api private
    sig { override.params(value: T.anything, state: Knockapi::Converter::State).returns(T.anything) }
    def coerce(value, state:)
    end
  ...
  class ArrayOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Enumerable[T.anything], T.anything), state: Knockapi::Converter::State)
  ...
  class HashOf
    ...
    sig(:final) do
      override
        .params(value: T.any(T::Hash[T.anything, T.anything], T.anything), state: Knockapi::Converter::State)
  ...
  class BaseModel
    ...
    class << self
      ...
      sig do
        override
          .params(
            value: T.any(Knockapi::BaseModel, T::Hash[T.anything, T.anything], T.anything),
            state: Knockapi::Converter::State
          )
