...
module Knockapi
  module Type
    # @api private
    module Converter
      Input = T.type_alias { T.any(Knockapi::Type::Converter, T::Class[T.anything]) }
      ...
      # @api private
      sig do
        overridable.params(value: T.anything, state: Knockapi::Type::Converter::State).returns(T.anything)
      end
      ...
      class << self
            ...
            spec: T.any(
              {
                ...
                enum: T.nilable(T.proc.returns(Knockapi::Type::Converter::Input)),
                union: T.nilable(T.proc.returns(Knockapi::Type::Converter::Input))
              },
        ...
        sig do
          params(
            target: Knockapi::Type::Converter::Input,
            value: T.anything,
        ...
        # @api private
        sig { params(target: Knockapi::Type::Converter::Input, value: T.anything).returns(T.anything) }
