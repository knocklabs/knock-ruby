...
module Knockapi
  module Type
    ...
    module Union
      ...
      sig { returns(T::Array[[T.nilable(Symbol), T.proc.returns(Knockapi::Type::Converter::Input)]]) }
      ...
      # @api private
      sig { override.params(value: T.anything, state: Knockapi::Type::Converter::State).returns(T.anything) }
