          ...
          params(
            ...
            commercial_subscribed:
              T.nilable(
                T.any(
                  T::Boolean,
                  Knockapi::Recipients::PreferenceSet::CommercialSubscribed::PreferenceSetCommercialSubscribedSetting::OrHash
                )
              ),
            workflows:
              T.nilable(
        ...
        module CommercialSubscribed
          ...
          Variants =
            T.type_alias do
              T.any(
                T::Boolean,
                Knockapi::Recipients::PreferenceSet::CommercialSubscribed::PreferenceSetCommercialSubscribedSetting
              )
            end
