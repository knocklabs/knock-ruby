...
module Knock
  ...
  module Converter
    ...
    class << self
      # @private
      #
      # @param spec [Hash{Symbol=>Object}, Proc, Knock::Converter, Class] .
      #
      ...
      #
      # @param target [Knock::Converter, Class]
      # @param value [Object]
      #
      # @return [Object]
      #
  ...
  class Unknown
    ...
    # @return [Boolean]
    #
    def self.==(other) = other.is_a?(Class) && other <= Knock::Unknown
  ...
  class BooleanModel
    ...
    # @return [Boolean]
    #
    def self.==(other) = other.is_a?(Class) && other <= Knock::BooleanModel
  ...
  class Enum
    ...
    #
    def self.==(other)
      other.is_a?(Class) && other <= Knock::Enum && other.values.to_set == values.to_set
    end
  ...
  # @example
  # ```ruby
  # # `recipient` is a `Knock::Models::Recipient`
  # case recipient
  # when Knock::Models::User
  #   # ...
  # when Knock::Models::Object
  #   # ...
  # else
  #   # ...
  # end
  ...
  class Union
    ...
    class << self
      ...
      # @private
      #
      # @param key [Symbol, Hash{Symbol=>Object}, Proc, Knock::Converter, Class]
      #
      # @param spec [Hash{Symbol=>Object}, Proc, Knock::Converter, Class] .
      #
      #   @option spec [NilClass, TrueClass, FalseClass, Integer, Float, Symbol] :const
      ...
      private def variant(key, spec = nil)
        variant_info =
          case key
          in Symbol
            [key, Knock::Converter.type_info(spec)]
          in Proc | Knock::Converter | Class | Hash
            [nil, Knock::Converter.type_info(key)]
          end
      ...
      # @param value [Object]
      #
      # @return [Knock::Converter, Class, nil]
      #
      private def resolve_variant(value)
        case [@discriminator, value]
        in [_, Knock::BaseModel]
          value.class
        in [Symbol, Hash]
          key =
          ...
          resolved.nil? ? Knock::Unknown : resolved.call
        else
          nil
        end
      end
    ...
    #
    def self.==(other)
      other.is_a?(Class) && other <= Knock::Union && other.variants == variants
    end
    ...
    class << self
      ...
      def coerce(value)
        if (variant = resolve_variant(value))
          return Knock::Converter.coerce(variant, value)
        end
        ...
        known_variants.each do |_, variant_fn|
          ...
          case Knock::Converter.try_strict_coerce(variant, value)
          in [true, coerced, _]
            return coerced
          in [false, true, score]
        ...
        variant.nil? ? value : Knock::Converter.coerce(variant, value)
      end
      ...
      def dump(value)
        if (variant = resolve_variant(value))
          return Knock::Converter.dump(variant, value)
        end
  ...
  class ArrayOf
    ...
    # @return [Boolean]
    #
    def ==(other) = other.is_a?(Knock::ArrayOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Enumerable unless value.is_a?(Hash)
        value.map { Knock::Converter.coerce(type, _1) }
      else
        value
      end
    end
    ...
    def dump(value)
      ...
      case value
      in Enumerable unless value.is_a?(Hash)
        value.map { Knock::Converter.dump(type, _1) }.to_a
      else
        value
      end
    end
    ...
    def try_strict_coerce(value)
      ...
      in Array
        ...
        mapped =
          value.map do |item|
            case Knock::Converter.try_strict_coerce(type, item)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
    ...
    # @private
    #
    # @return [Knock::Converter, Class]
    #
    protected def item_type = @item_type_fn.call

    # @private
    #
    # @param type_info [Hash{Symbol=>Object}, Proc, Knock::Converter, Class]
    #
    ...
    def initialize(type_info, spec = {})
      @item_type_fn = Knock::Converter.type_info(type_info || spec)
    end
  end
  ...
  class HashOf
    ...
    # @return [Boolean]
    #
    def ==(other) = other.is_a?(Knock::HashOf) && other.item_type == item_type
    ...
    def coerce(value)
      ...
      in Hash
        value.to_h do |key, val|
          coerced = Knock::Converter.coerce(type, val)
    ...
    def try_strict_coerce(value)
      ...
      in Hash
        ...
        mapped =
          value.transform_values do |val|
            case Knock::Converter.try_strict_coerce(type, val)
            in [true, coerced, score]
              tally += score
              coerced
            in [false, true, score]
  ...
  class BaseModel
    ...
    class << self
      ...
      #
      def known_fields
        @known_fields ||= (self < Knock::BaseModel ? superclass.known_fields.dup : {})
      end
      ...
      private def add_field(name_sym, required:, type_info:, spec:)
        type_fn, info =
          case type_info
          in Proc | Class | Knock::Converter
            [Knock::Converter.type_info({**spec, union: type_info}), spec]
          in Hash
            [Knock::Converter.type_info(type_info), type_info]
          end
        ...
        define_method(name_sym) do
          ...
          Knock::Converter.coerce(field_type, value)
        rescue StandardError
          name = self.class.name.split("::").last
          raise Knock::ConversionError.new(
    ...
    class << self
      # @private
      #
      # @param value [Knock::BaseModel, Hash{Object=>Object}, Object]
      #
      # @return [Knock::BaseModel, Object]
      #
      def coerce(value)
        case Knock::Util.coerce_hash(value)
        in Hash => coerced
          new(coerced)
        else
          value
      ...
      # @private
      #
      # @param value [Knock::BaseModel, Object]
      #
      # @return [Hash{Object=>Object}, Object]
      #
      def dump(value)
        unless (coerced = Knock::Util.coerce_hash(value)).is_a?(Hash)
          return value
        end
        ...
        values = coerced.filter_map do |key, val|
          ...
          in nil
            ...
            in :coerce
              ...
              target = type_fn.call
              [api_name, Knock::Converter.dump(target, val)]
            end
          end
        end.to_h
      ...
      def try_strict_coerce(value)
        ...
        known_fields.each_value do |field|
          ...
          in [_, true]
            ...
            case Knock::Converter.try_strict_coerce(target, item)
            in [true, coerced, score]
              tally += score
    ...
    #
    # @param data [Hash{Symbol=>Object}, Knock::BaseModel]
    #
    def initialize(data = {})
      case Knock::Util.coerce_hash(data)
      in Hash => coerced
        @data = coerced.transform_keys(&:to_sym)
      else
        raise ArgumentError.new("Expected a #{Hash} or #{Knock::BaseModel}, got #{data.inspect}")
      end
    end
