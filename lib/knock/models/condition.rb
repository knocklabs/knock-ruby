...
module Knock
  module Models
    class Condition < Knock::BaseModel
      ...
      # @!attribute operator
      #
      #   @return [Symbol, Knock::Models::Condition::Operator]
      required :operator, enum: -> { Knock::Models::Condition::Operator }
      ...
      #   # @param operator [Symbol, Knock::Models::Condition::Operator]
