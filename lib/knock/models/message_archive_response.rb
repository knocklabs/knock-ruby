...
module Knock
  module Models
    class MessageArchiveResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::MessageArchiveResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::MessageArchiveResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::MessageArchiveResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageArchiveResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageArchiveResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageArchiveResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::MessageArchiveResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::MessageArchiveResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::MessageArchiveResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::MessageArchiveResponse::Source, nil]
      optional :source, -> { Knock::Models::MessageArchiveResponse::Source }

      # @!parse
      #   # @return [Knock::Models::MessageArchiveResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::MessageArchiveResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::MessageArchiveResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::MessageArchiveResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::MessageArchiveResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::MessageArchiveResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::MessageArchiveResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::MessageArchiveResponse::Source]
      #   # @param status [Symbol, Knock::Models::MessageArchiveResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::MessageArchiveResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::MessageArchiveResponse::Recipient::ObjectReference }
