...
module Knock
  module Models
    class MessageMarkAsInteractedResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::MessageMarkAsInteractedResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::MessageMarkAsInteractedResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::MessageMarkAsInteractedResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageMarkAsInteractedResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageMarkAsInteractedResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageMarkAsInteractedResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::MessageMarkAsInteractedResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::MessageMarkAsInteractedResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::MessageMarkAsInteractedResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::MessageMarkAsInteractedResponse::Source, nil]
      optional :source, -> { Knock::Models::MessageMarkAsInteractedResponse::Source }

      # @!parse
      #   # @return [Knock::Models::MessageMarkAsInteractedResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::MessageMarkAsInteractedResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::MessageMarkAsInteractedResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::MessageMarkAsInteractedResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::MessageMarkAsInteractedResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::MessageMarkAsInteractedResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::MessageMarkAsInteractedResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::MessageMarkAsInteractedResponse::Source]
      #   # @param status [Symbol, Knock::Models::MessageMarkAsInteractedResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::MessageMarkAsInteractedResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::MessageMarkAsInteractedResponse::Recipient::ObjectReference }
