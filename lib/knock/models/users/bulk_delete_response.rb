  ...
  module Models
    module Users
      class BulkDeleteResponse < Knock::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Users::BulkDeleteResponse::Status]
        required :status, enum: -> { Knock::Models::Users::BulkDeleteResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Users::BulkDeleteResponse::ErrorItem>, nil]
        optional :error_items, -> { Knock::ArrayOf[Knock::Models::Users::BulkDeleteResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Users::BulkDeleteResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Users::BulkDeleteResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Users::BulkDeleteResponse::ErrorItem>]
