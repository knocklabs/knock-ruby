...
module Knock
  module Models
    module Users
      class BulkSetPreferencesResponse < Knock::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Users::BulkSetPreferencesResponse::Status]
        required :status, enum: -> { Knock::Models::Users::BulkSetPreferencesResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Users::BulkSetPreferencesResponse::ErrorItem>, nil]
        optional :error_items, -> { Knock::ArrayOf[Knock::Models::Users::BulkSetPreferencesResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Users::BulkSetPreferencesResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Users::BulkSetPreferencesResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Users::BulkSetPreferencesResponse::ErrorItem>]
