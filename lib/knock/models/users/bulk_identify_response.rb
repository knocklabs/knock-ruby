  ...
  module Models
    module Users
      class BulkIdentifyResponse < Knock::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Users::BulkIdentifyResponse::Status]
        required :status, enum: -> { Knock::Models::Users::BulkIdentifyResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Users::BulkIdentifyResponse::ErrorItem>, nil]
        optional :error_items, -> { Knock::ArrayOf[Knock::Models::Users::BulkIdentifyResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Users::BulkIdentifyResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Users::BulkIdentifyResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Users::BulkIdentifyResponse::ErrorItem>]
