...
module Knock
  module Models
    module Tenants
      class BulkDeleteResponse < Knock::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Tenants::BulkDeleteResponse::Status]
        required :status, enum: -> { Knock::Models::Tenants::BulkDeleteResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Tenants::BulkDeleteResponse::ErrorItem>, nil]
        optional :error_items, -> { Knock::ArrayOf[Knock::Models::Tenants::BulkDeleteResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Tenants::BulkDeleteResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Tenants::BulkDeleteResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Tenants::BulkDeleteResponse::ErrorItem>]
