  ...
  module Models
    module Tenants
      class BulkSetResponse < Knock::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Tenants::BulkSetResponse::Status]
        required :status, enum: -> { Knock::Models::Tenants::BulkSetResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Tenants::BulkSetResponse::ErrorItem>, nil]
        optional :error_items, -> { Knock::ArrayOf[Knock::Models::Tenants::BulkSetResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Tenants::BulkSetResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Tenants::BulkSetResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Tenants::BulkSetResponse::ErrorItem>]
