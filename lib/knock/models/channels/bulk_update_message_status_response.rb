...
module Knock
  module Models
    module Channels
      class BulkUpdateMessageStatusResponse < Knock::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Channels::BulkUpdateMessageStatusResponse::Status]
        required :status, enum: -> { Knock::Models::Channels::BulkUpdateMessageStatusResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Channels::BulkUpdateMessageStatusResponse::ErrorItem>, nil]
        optional :error_items,
                 -> { Knock::ArrayOf[Knock::Models::Channels::BulkUpdateMessageStatusResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Channels::BulkUpdateMessageStatusResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Channels::BulkUpdateMessageStatusResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Channels::BulkUpdateMessageStatusResponse::ErrorItem>]
