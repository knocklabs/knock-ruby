  ...
  module Models
    module Messages
      class BatchArchiveResponseItem < Knock::BaseModel
        ...
        #
        #   @return [Array<String, Knock::Models::Messages::BatchArchiveResponseItem::Actor::ObjectReference>, nil]
        optional :actors, -> { Knock::ArrayOf[union: Knock::Models::Messages::BatchArchiveResponseItem::Actor] }

        # @!parse
        #   # @return [Array<String, Knock::Models::Messages::BatchArchiveResponseItem::Actor::ObjectReference>]
        #   attr_writer :actors
        ...
        #
        #   @return [Array<Symbol, Knock::Models::Messages::BatchArchiveResponseItem::EngagementStatus>, nil]
        optional :engagement_statuses,
                 -> { Knock::ArrayOf[enum: Knock::Models::Messages::BatchArchiveResponseItem::EngagementStatus] }

        # @!parse
        #   # @return [Array<Symbol, Knock::Models::Messages::BatchArchiveResponseItem::EngagementStatus>]
        ...
        #
        #   @return [String, Knock::Models::Messages::BatchArchiveResponseItem::Recipient::ObjectReference, nil]
        optional :recipient, union: -> { Knock::Models::Messages::BatchArchiveResponseItem::Recipient }

        # @!parse
        #   # @return [String, Knock::Models::Messages::BatchArchiveResponseItem::Recipient::ObjectReference]
        ...
        #   Source information
        #
        #   @return [Knock::Models::Messages::BatchArchiveResponseItem::Source, nil]
        optional :source, -> { Knock::Models::Messages::BatchArchiveResponseItem::Source }

        # @!parse
        #   # @return [Knock::Models::Messages::BatchArchiveResponseItem::Source]
        #   attr_writer :source

        # @!attribute [r] status
        #   Message delivery status
        #
        #   @return [Symbol, Knock::Models::Messages::BatchArchiveResponseItem::Status, nil]
        optional :status, enum: -> { Knock::Models::Messages::BatchArchiveResponseItem::Status }

        # @!parse
        #   # @return [Symbol, Knock::Models::Messages::BatchArchiveResponseItem::Status]
        #   attr_writer :status
        ...
        #   # @param actors [Array<String, Knock::Models::Messages::BatchArchiveResponseItem::Actor::ObjectReference>]
        #   # @param archived_at [Time, nil]
        #   # @param channel_id [String]
        #   # @param clicked_at [Time, nil]
        #   # @param data [Hash{Symbol=>Object}, nil]
        #   # @param engagement_statuses [Array<Symbol, Knock::Models::Messages::BatchArchiveResponseItem::EngagementStatus>]
        ...
        #   # @param recipient [String, Knock::Models::Messages::BatchArchiveResponseItem::Recipient::ObjectReference]
        #   # @param scheduled_at [Time, nil]
        #   # @param seen_at [Time, nil]
        #   # @param source [Knock::Models::Messages::BatchArchiveResponseItem::Source]
        #   # @param status [Symbol, Knock::Models::Messages::BatchArchiveResponseItem::Status]
        ...
        class Actor < Knock::Union
          ...
          variant -> { Knock::Models::Messages::BatchArchiveResponseItem::Actor::ObjectReference }
        ...
        class Recipient < Knock::Union
          ...
          # An object reference to a recipient
          variant -> { Knock::Models::Messages::BatchArchiveResponseItem::Recipient::ObjectReference }
      ...
      BatchArchiveResponse = Knock::ArrayOf[-> { Knock::Models::Messages::BatchArchiveResponseItem }]
    end
  end
end
