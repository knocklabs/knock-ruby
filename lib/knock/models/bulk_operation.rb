...
module Knock
  module Models
    class BulkOperation < Knock::BaseModel
      # @!attribute id
      #
      #   @return [String]
      required :id, String
      ...
      # @!attribute status
      #
      #   @return [Symbol, Knock::Models::BulkOperation::Status]
      required :status, enum: -> { Knock::Models::BulkOperation::Status }
      ...
      #
      #   @return [Array<Knock::Models::BulkOperation::ErrorItem>, nil]
      optional :error_items, -> { Knock::ArrayOf[Knock::Models::BulkOperation::ErrorItem] }

      # @!parse
      #   # @return [Array<Knock::Models::BulkOperation::ErrorItem>]
      ...
      #   # @param status [Symbol, Knock::Models::BulkOperation::Status]
      #   # @param success_count [Integer]
      #   # @param updated_at [Time]
      #   # @param completed_at [Time, nil]
      #   # @param error_count [Integer]
      #   # @param error_items [Array<Knock::Models::BulkOperation::ErrorItem>]
