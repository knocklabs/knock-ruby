...
module Knock
  module Models
    class MessageEvent < Knock::BaseModel
      ...
      #
      #   @return [String, Knock::Models::MessageEvent::Recipient::ObjectReference]
      required :recipient, union: -> { Knock::Models::MessageEvent::Recipient }

      # @!attribute type
      #
      #   @return [Symbol, Knock::Models::MessageEvent::Type]
      required :type, enum: -> { Knock::Models::MessageEvent::Type }
      ...
      #   # @param recipient [String, Knock::Models::MessageEvent::Recipient::ObjectReference]
      #   # @param type [Symbol, Knock::Models::MessageEvent::Type]
      ...
      class Recipient < Knock::Union
        ...
        variant -> { Knock::Models::MessageEvent::Recipient::ObjectReference }
