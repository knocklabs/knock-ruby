...
module Knock
  module Models
    class AudienceAddMembersParams < Knock::BaseModel
      ...
      # @!attribute members
      #
      #   @return [Array<Knock::Models::AudienceAddMembersParams::Member>]
      required :members, -> { Knock::ArrayOf[Knock::Models::AudienceAddMembersParams::Member] }

      # @!parse
      #   # @param members [Array<Knock::Models::AudienceAddMembersParams::Member>]
