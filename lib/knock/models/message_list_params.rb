...
module Knock
  module Models
    class MessageListParams < Knock::BaseModel
      # @!parse
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageListParams::EngagementStatus>, nil]
      optional :engagement_status,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageListParams::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageListParams::EngagementStatus>]
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageListParams::Status>, nil]
      optional :status, -> { Knock::ArrayOf[enum: Knock::Models::MessageListParams::Status] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageListParams::Status>]
      #   attr_writer :status
      ...
      #   # @param engagement_status [Array<Symbol, Knock::Models::MessageListParams::EngagementStatus>]
      #   # @param message_ids [Array<String>]
      #   # @param page_size [Integer]
      #   # @param source [String]
      #   # @param status [Array<Symbol, Knock::Models::MessageListParams::Status>]
      #   # @param tenant [String]
