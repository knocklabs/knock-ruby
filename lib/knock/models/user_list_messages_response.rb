...
module Knock
  module Models
    class UserListMessagesResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::UserListMessagesResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::UserListMessagesResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::UserListMessagesResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::UserListMessagesResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::UserListMessagesResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::UserListMessagesResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::UserListMessagesResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::UserListMessagesResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::UserListMessagesResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::UserListMessagesResponse::Source, nil]
      optional :source, -> { Knock::Models::UserListMessagesResponse::Source }

      # @!parse
      #   # @return [Knock::Models::UserListMessagesResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::UserListMessagesResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::UserListMessagesResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::UserListMessagesResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::UserListMessagesResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::UserListMessagesResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::UserListMessagesResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::UserListMessagesResponse::Source]
      #   # @param status [Symbol, Knock::Models::UserListMessagesResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::UserListMessagesResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::UserListMessagesResponse::Recipient::ObjectReference }
