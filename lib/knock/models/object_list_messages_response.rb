...
module Knock
  module Models
    class ObjectListMessagesResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::ObjectListMessagesResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::ObjectListMessagesResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::ObjectListMessagesResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::ObjectListMessagesResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::ObjectListMessagesResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::ObjectListMessagesResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::ObjectListMessagesResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::ObjectListMessagesResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::ObjectListMessagesResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::ObjectListMessagesResponse::Source, nil]
      optional :source, -> { Knock::Models::ObjectListMessagesResponse::Source }

      # @!parse
      #   # @return [Knock::Models::ObjectListMessagesResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::ObjectListMessagesResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::ObjectListMessagesResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::ObjectListMessagesResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::ObjectListMessagesResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::ObjectListMessagesResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::ObjectListMessagesResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::ObjectListMessagesResponse::Source]
      #   # @param status [Symbol, Knock::Models::ObjectListMessagesResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::ObjectListMessagesResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::ObjectListMessagesResponse::Recipient::ObjectReference }
