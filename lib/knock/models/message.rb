...
module Knock
  module Models
    class Message < Knock::BaseModel
      ...
      #
      #   @return [Array<String, Knock::Models::Message::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::Message::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::Message::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::Message::EngagementStatus>, nil]
      optional :engagement_statuses, -> { Knock::ArrayOf[enum: Knock::Models::Message::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::Message::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::Message::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::Message::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::Message::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::Message::Source, nil]
      optional :source, -> { Knock::Models::Message::Source }

      # @!parse
      #   # @return [Knock::Models::Message::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::Message::Status, nil]
      optional :status, enum: -> { Knock::Models::Message::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::Message::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::Message::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::Message::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::Message::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::Message::Source]
      #   # @param status [Symbol, Knock::Models::Message::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::Message::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::Message::Recipient::ObjectReference }
