...
module Knock
  module Models
    class MessageMarkAsUnseenResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::MessageMarkAsUnseenResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::MessageMarkAsUnseenResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::MessageMarkAsUnseenResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageMarkAsUnseenResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageMarkAsUnseenResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageMarkAsUnseenResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::MessageMarkAsUnseenResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::MessageMarkAsUnseenResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::MessageMarkAsUnseenResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::MessageMarkAsUnseenResponse::Source, nil]
      optional :source, -> { Knock::Models::MessageMarkAsUnseenResponse::Source }

      # @!parse
      #   # @return [Knock::Models::MessageMarkAsUnseenResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::MessageMarkAsUnseenResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::MessageMarkAsUnseenResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::MessageMarkAsUnseenResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::MessageMarkAsUnseenResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::MessageMarkAsUnseenResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::MessageMarkAsUnseenResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::MessageMarkAsUnseenResponse::Source]
      #   # @param status [Symbol, Knock::Models::MessageMarkAsUnseenResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::MessageMarkAsUnseenResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::MessageMarkAsUnseenResponse::Recipient::ObjectReference }
