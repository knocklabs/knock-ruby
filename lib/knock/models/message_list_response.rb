...
module Knock
  module Models
    class MessageListResponse < Knock::BaseModel
      ...
      #
      #   @return [Array<String, Knock::Models::MessageListResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::MessageListResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::MessageListResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageListResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageListResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageListResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::MessageListResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::MessageListResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::MessageListResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::MessageListResponse::Source, nil]
      optional :source, -> { Knock::Models::MessageListResponse::Source }

      # @!parse
      #   # @return [Knock::Models::MessageListResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::MessageListResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::MessageListResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::MessageListResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::MessageListResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::MessageListResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::MessageListResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::MessageListResponse::Source]
      #   # @param status [Symbol, Knock::Models::MessageListResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::MessageListResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::MessageListResponse::Recipient::ObjectReference }
