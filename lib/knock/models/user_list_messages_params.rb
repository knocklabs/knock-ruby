...
module Knock
  module Models
    class UserListMessagesParams < Knock::BaseModel
      # @!parse
      ...
      #
      #   @return [Array<Symbol, Knock::Models::UserListMessagesParams::EngagementStatus>, nil]
      optional :engagement_status,
               -> { Knock::ArrayOf[enum: Knock::Models::UserListMessagesParams::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::UserListMessagesParams::EngagementStatus>]
      ...
      optional :message_ids, Knock::ArrayOf[String]
      ...
      #
      #   @return [Array<Symbol, Knock::Models::UserListMessagesParams::Status>, nil]
      optional :status, -> { Knock::ArrayOf[enum: Knock::Models::UserListMessagesParams::Status] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::UserListMessagesParams::Status>]
      #   attr_writer :status
      ...
      #   # @param engagement_status [Array<Symbol, Knock::Models::UserListMessagesParams::EngagementStatus>]
      #   # @param message_ids [Array<String>]
      #   # @param page_size [Integer]
      #   # @param source [String]
      #   # @param status [Array<Symbol, Knock::Models::UserListMessagesParams::Status>]
      #   # @param tenant [String]
