  ...
  module Models
    module Objects
      class BulkDeleteResponse < Knock::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Objects::BulkDeleteResponse::Status]
        required :status, enum: -> { Knock::Models::Objects::BulkDeleteResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Objects::BulkDeleteResponse::ErrorItem>, nil]
        optional :error_items, -> { Knock::ArrayOf[Knock::Models::Objects::BulkDeleteResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Objects::BulkDeleteResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Objects::BulkDeleteResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Objects::BulkDeleteResponse::ErrorItem>]
