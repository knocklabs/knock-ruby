...
module Knock
  module Models
    module Objects
      class BulkAddSubscriptionsResponse < Knock::BaseModel
        # @!attribute id
        #
        #   @return [String]
        required :id, String
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Objects::BulkAddSubscriptionsResponse::Status]
        required :status, enum: -> { Knock::Models::Objects::BulkAddSubscriptionsResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Objects::BulkAddSubscriptionsResponse::ErrorItem>, nil]
        optional :error_items,
                 -> { Knock::ArrayOf[Knock::Models::Objects::BulkAddSubscriptionsResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Objects::BulkAddSubscriptionsResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Objects::BulkAddSubscriptionsResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Objects::BulkAddSubscriptionsResponse::ErrorItem>]
