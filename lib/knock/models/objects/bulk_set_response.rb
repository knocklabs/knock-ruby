  ...
  module Models
    module Objects
      class BulkSetResponse < Knock::BaseModel
        ...
        # @!attribute status
        #
        #   @return [Symbol, Knock::Models::Objects::BulkSetResponse::Status]
        required :status, enum: -> { Knock::Models::Objects::BulkSetResponse::Status }
        ...
        #
        #   @return [Array<Knock::Models::Objects::BulkSetResponse::ErrorItem>, nil]
        optional :error_items, -> { Knock::ArrayOf[Knock::Models::Objects::BulkSetResponse::ErrorItem] }

        # @!parse
        #   # @return [Array<Knock::Models::Objects::BulkSetResponse::ErrorItem>]
        ...
        #   # @param status [Symbol, Knock::Models::Objects::BulkSetResponse::Status]
        #   # @param success_count [Integer]
        #   # @param updated_at [Time]
        #   # @param completed_at [Time, nil]
        #   # @param error_count [Integer]
        #   # @param error_items [Array<Knock::Models::Objects::BulkSetResponse::ErrorItem>]
