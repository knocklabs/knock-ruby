...
module Knock
  module Models
    class ScheduleRepeatRule < Knock::BaseModel
      ...
      # @!attribute frequency
      #
      #   @return [Symbol, Knock::Models::ScheduleRepeatRule::Frequency]
      required :frequency, enum: -> { Knock::Models::ScheduleRepeatRule::Frequency }
      ...
      # @!attribute days
      #
      #   @return [Array<Symbol, Knock::Models::ScheduleRepeatRule::Day>, nil]
      optional :days, -> { Knock::ArrayOf[enum: Knock::Models::ScheduleRepeatRule::Day] }, nil?: true
      ...
      #   # @param frequency [Symbol, Knock::Models::ScheduleRepeatRule::Frequency]
      #   # @param day_of_month [Integer, nil]
      #   # @param days [Array<Symbol, Knock::Models::ScheduleRepeatRule::Day>, nil]
