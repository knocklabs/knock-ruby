  ...
  module Models
    module Providers
      class MsTeamListChannelsParams < Knock::BaseModel
        ...
        #
        #   @return [Knock::Models::Providers::MsTeamListChannelsParams::QueryOptions, nil]
        optional :query_options, -> { Knock::Models::Providers::MsTeamListChannelsParams::QueryOptions }

        # @!parse
        #   # @return [Knock::Models::Providers::MsTeamListChannelsParams::QueryOptions]
        #   attr_writer :query_options

        # @!parse
        #   # @param ms_teams_tenant_object [String]
        #   # @param team_id [String]
        #   # @param query_options [Knock::Models::Providers::MsTeamListChannelsParams::QueryOptions]
