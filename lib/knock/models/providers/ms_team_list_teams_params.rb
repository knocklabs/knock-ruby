  ...
  module Models
    module Providers
      class MsTeamListTeamsParams < Knock::BaseModel
        ...
        #
        #   @return [Knock::Models::Providers::MsTeamListTeamsParams::QueryOptions, nil]
        optional :query_options, -> { Knock::Models::Providers::MsTeamListTeamsParams::QueryOptions }

        # @!parse
        #   # @return [Knock::Models::Providers::MsTeamListTeamsParams::QueryOptions]
        #   attr_writer :query_options

        # @!parse
        #   # @param ms_teams_tenant_object [String]
        #   # @param query_options [Knock::Models::Providers::MsTeamListTeamsParams::QueryOptions]
