  ...
  module Models
    module Providers
      class SlackCheckAuthResponse < Knock::BaseModel
        ...
        #
        #   @return [Knock::Models::Providers::SlackCheckAuthResponse::Connection]
        required :connection, -> { Knock::Models::Providers::SlackCheckAuthResponse::Connection }

        # @!parse
        #   # The response from a Slack auth check request
        #   #
        #   # @param connection [Knock::Models::Providers::SlackCheckAuthResponse::Connection]
        #   #
