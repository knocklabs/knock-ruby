...
module Knock
  module Models
    class MessageMarkAsUnreadResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::MessageMarkAsUnreadResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::MessageMarkAsUnreadResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::MessageMarkAsUnreadResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageMarkAsUnreadResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageMarkAsUnreadResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageMarkAsUnreadResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::MessageMarkAsUnreadResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::MessageMarkAsUnreadResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::MessageMarkAsUnreadResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::MessageMarkAsUnreadResponse::Source, nil]
      optional :source, -> { Knock::Models::MessageMarkAsUnreadResponse::Source }

      # @!parse
      #   # @return [Knock::Models::MessageMarkAsUnreadResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::MessageMarkAsUnreadResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::MessageMarkAsUnreadResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::MessageMarkAsUnreadResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::MessageMarkAsUnreadResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::MessageMarkAsUnreadResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::MessageMarkAsUnreadResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::MessageMarkAsUnreadResponse::Source]
      #   # @param status [Symbol, Knock::Models::MessageMarkAsUnreadResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::MessageMarkAsUnreadResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::MessageMarkAsUnreadResponse::Recipient::ObjectReference }
