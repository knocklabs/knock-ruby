...
module Knock
  module Models
    class MessageMarkAsReadResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::MessageMarkAsReadResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::MessageMarkAsReadResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::MessageMarkAsReadResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageMarkAsReadResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageMarkAsReadResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageMarkAsReadResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::MessageMarkAsReadResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::MessageMarkAsReadResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::MessageMarkAsReadResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::MessageMarkAsReadResponse::Source, nil]
      optional :source, -> { Knock::Models::MessageMarkAsReadResponse::Source }

      # @!parse
      #   # @return [Knock::Models::MessageMarkAsReadResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::MessageMarkAsReadResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::MessageMarkAsReadResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::MessageMarkAsReadResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::MessageMarkAsReadResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::MessageMarkAsReadResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::MessageMarkAsReadResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::MessageMarkAsReadResponse::Source]
      #   # @param status [Symbol, Knock::Models::MessageMarkAsReadResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::MessageMarkAsReadResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::MessageMarkAsReadResponse::Recipient::ObjectReference }
