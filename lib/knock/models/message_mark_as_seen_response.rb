...
module Knock
  module Models
    class MessageMarkAsSeenResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::MessageMarkAsSeenResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::MessageMarkAsSeenResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::MessageMarkAsSeenResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageMarkAsSeenResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageMarkAsSeenResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageMarkAsSeenResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::MessageMarkAsSeenResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::MessageMarkAsSeenResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::MessageMarkAsSeenResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::MessageMarkAsSeenResponse::Source, nil]
      optional :source, -> { Knock::Models::MessageMarkAsSeenResponse::Source }

      # @!parse
      #   # @return [Knock::Models::MessageMarkAsSeenResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::MessageMarkAsSeenResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::MessageMarkAsSeenResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::MessageMarkAsSeenResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::MessageMarkAsSeenResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::MessageMarkAsSeenResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::MessageMarkAsSeenResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::MessageMarkAsSeenResponse::Source]
      #   # @param status [Symbol, Knock::Models::MessageMarkAsSeenResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::MessageMarkAsSeenResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::MessageMarkAsSeenResponse::Recipient::ObjectReference }
