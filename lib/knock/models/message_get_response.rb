...
module Knock
  module Models
    class MessageGetResponse < Knock::BaseModel
      # @!attribute [r] id
      #   The message ID
      #
      #   @return [String, nil]
      ...
      #
      #   @return [Array<String, Knock::Models::MessageGetResponse::Actor::ObjectReference>, nil]
      optional :actors, -> { Knock::ArrayOf[union: Knock::Models::MessageGetResponse::Actor] }

      # @!parse
      #   # @return [Array<String, Knock::Models::MessageGetResponse::Actor::ObjectReference>]
      #   attr_writer :actors
      ...
      #
      #   @return [Array<Symbol, Knock::Models::MessageGetResponse::EngagementStatus>, nil]
      optional :engagement_statuses,
               -> { Knock::ArrayOf[enum: Knock::Models::MessageGetResponse::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::MessageGetResponse::EngagementStatus>]
      ...
      #
      #   @return [String, Knock::Models::MessageGetResponse::Recipient::ObjectReference, nil]
      optional :recipient, union: -> { Knock::Models::MessageGetResponse::Recipient }

      # @!parse
      #   # @return [String, Knock::Models::MessageGetResponse::Recipient::ObjectReference]
      ...
      #   Source information
      #
      #   @return [Knock::Models::MessageGetResponse::Source, nil]
      optional :source, -> { Knock::Models::MessageGetResponse::Source }

      # @!parse
      #   # @return [Knock::Models::MessageGetResponse::Source]
      #   attr_writer :source

      # @!attribute [r] status
      #   Message delivery status
      #
      #   @return [Symbol, Knock::Models::MessageGetResponse::Status, nil]
      optional :status, enum: -> { Knock::Models::MessageGetResponse::Status }

      # @!parse
      #   # @return [Symbol, Knock::Models::MessageGetResponse::Status]
      #   attr_writer :status
      ...
      #   # @param actors [Array<String, Knock::Models::MessageGetResponse::Actor::ObjectReference>]
      #   # @param archived_at [Time, nil]
      #   # @param channel_id [String]
      #   # @param clicked_at [Time, nil]
      #   # @param data [Hash{Symbol=>Object}, nil]
      #   # @param engagement_statuses [Array<Symbol, Knock::Models::MessageGetResponse::EngagementStatus>]
      ...
      #   # @param recipient [String, Knock::Models::MessageGetResponse::Recipient::ObjectReference]
      #   # @param scheduled_at [Time, nil]
      #   # @param seen_at [Time, nil]
      #   # @param source [Knock::Models::MessageGetResponse::Source]
      #   # @param status [Symbol, Knock::Models::MessageGetResponse::Status]
      ...
      class Actor < Knock::Union
        ...
        variant -> { Knock::Models::MessageGetResponse::Actor::ObjectReference }
      ...
      class Recipient < Knock::Union
        ...
        # An object reference to a recipient
        variant -> { Knock::Models::MessageGetResponse::Recipient::ObjectReference }
