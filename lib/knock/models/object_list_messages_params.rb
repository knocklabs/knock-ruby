...
module Knock
  module Models
    class ObjectListMessagesParams < Knock::BaseModel
      ...
      #
      #   @return [Array<Symbol, Knock::Models::ObjectListMessagesParams::EngagementStatus>, nil]
      optional :engagement_status,
               -> { Knock::ArrayOf[enum: Knock::Models::ObjectListMessagesParams::EngagementStatus] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::ObjectListMessagesParams::EngagementStatus>]
      ...
      #
      #   @return [Array<Symbol, Knock::Models::ObjectListMessagesParams::Status>, nil]
      optional :status, -> { Knock::ArrayOf[enum: Knock::Models::ObjectListMessagesParams::Status] }

      # @!parse
      #   # @return [Array<Symbol, Knock::Models::ObjectListMessagesParams::Status>]
      #   attr_writer :status
      ...
      #   # @param engagement_status [Array<Symbol, Knock::Models::ObjectListMessagesParams::EngagementStatus>]
      #   # @param message_ids [Array<String>]
      #   # @param page_size [Integer]
      #   # @param source [String]
      #   # @param status [Array<Symbol, Knock::Models::ObjectListMessagesParams::Status>]
      #   # @param tenant [String]
