...
module Knock
  module Resources
    class Messages
      # @return [Knock::Resources::Messages::Batch]
      attr_reader :batch

      # List messages
      #
      # @param params [Knock::Models::MessageListParams, Hash{Symbol=>Object}] .
      #
      ...
      #
      #   @option params [Array<Symbol, Knock::Models::MessageListParams::EngagementStatus>] :engagement_status The engagement status of the message
      #
      ...
      #
      #   @option params [Array<Symbol, Knock::Models::MessageListParams::Status>] :status The status of the message
      #
      ...
      #
      # @param params [Knock::Models::MessageArchiveParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Knock::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      ...
      # @param message_id [String] The message ID
      #
      # @param params [Knock::Models::MessageGetParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Knock::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      # @return [Knock::Models::Message]
      ...
      #
      # @param params [Knock::Models::MessageGetContentParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Knock::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      # @return [Knock::Models::MessageGetContentResponse]
      #
      def get_content(message_id, params = {})
        @client.request(
          method: :get,
          path: ["v1/messages/%0s/content", message_id],
          model: Knock::Models::MessageGetContentResponse,
          options: params[:request_options]
        )
      end
      ...
      #
      # @param params [Knock::Models::MessageListActivitiesParams, Hash{Symbol=>Object}] .
      #
      #   @option params [String] :after The cursor to fetch entries after
      #
      #   @option params [String] :before The cursor to fetch entries before
      ...
      #
      # @param params [Knock::Models::MessageListDeliveryLogsParams, Hash{Symbol=>Object}] .
      #
      #   @option params [String] :after The cursor to fetch entries after
      #
      #   @option params [String] :before The cursor to fetch entries before
      ...
      #
      # @param params [Knock::Models::MessageListEventsParams, Hash{Symbol=>Object}] .
      #
      #   @option params [String] :after The cursor to fetch entries after
      #
      #   @option params [String] :before The cursor to fetch entries before
      ...
      # @param message_id [String] The message ID
      #
      # @param params [Knock::Models::MessageMarkAsInteractedParams, Hash{Symbol=>Object}] .
      #
      ...
      # @param message_id [String] The message ID
      #
      # @param params [Knock::Models::MessageMarkAsReadParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Knock::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      # @return [Knock::Models::Message]
      ...
      # @param message_id [String] The message ID
      #
      # @param params [Knock::Models::MessageMarkAsSeenParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Knock::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      # @return [Knock::Models::Message]
      ...
      # @param message_id [String] The message ID
      #
      # @param params [Knock::Models::MessageMarkAsUnreadParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Knock::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      # @return [Knock::Models::Message]
      ...
      # @param message_id [String] The message ID
      #
      # @param params [Knock::Models::MessageMarkAsUnseenParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Knock::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      # @return [Knock::Models::Message]
      ...
      # @param message_id [String] The message ID
      #
      # @param params [Knock::Models::MessageUnarchiveParams, Hash{Symbol=>Object}] .
      #
      #   @option params [Knock::RequestOptions, Hash{Symbol=>Object}, nil] :request_options
      #
      # @return [Knock::Models::Message]
      ...
      def initialize(client:)
        @client = client
        @batch = Knock::Resources::Messages::Batch.new(client: client)
      end
    end
  end
end
