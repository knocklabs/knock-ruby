        ...
        module Data
          ...
          class PushChannelDataFull < Knockapi::Internal::Type::BaseModel
            ...
            class Device < Knockapi::Internal::Type::BaseModel
              ...
              #
              #   @param locale [String] The locale of the object. Used for [message localization](/concepts/translations
              #
              #   @param timezone [String] The timezone of the object. Must be a valid [tz database time zone string](https
            end
          end
