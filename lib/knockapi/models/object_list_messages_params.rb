  ...
  module Models
    class ObjectListMessagesParams < Knockapi::BaseModel
      ...
      optional :engagement_status,
               -> { Knockapi::ArrayOf[enum: Knockapi::Models::ObjectListMessagesParams::EngagementStatus] }
      ...
      optional :status, -> { Knockapi::ArrayOf[enum: Knockapi::Models::ObjectListMessagesParams::Status] }
