    ...
    module Type
      ...
      module Converter
        ...
        def dump(value, state:)
          case value
          in Array
            value.map { Knockapi::Internal::Type::Unknown.dump(_1, state: state) }
          in Hash
            value.transform_values { Knockapi::Internal::Type::Unknown.dump(_1, state: state) }
          ...
          in Pathname | IO
            ...
            Knockapi::Internal::Util::SerializationAdapter.new(value)
          else
            value
          end
        end
        ...
        class << self
          ...
          #
          # @param target [Knockapi::Internal::Type::Converter, Class]
          #
          # @param value [Object]
          #
          ...
          def dump(target, value, state: {can_retry: true})
            ...
            in Knockapi::Internal::Type::Converter
              ...
              Knockapi::Internal::Type::Unknown.dump(value, state: state)
            end
          end
        end
      end
