    ...
    module Type
      ...
      module Union
        ...
        def ==(other)
          ...
          other.is_a?(Module) && other.singleton_class <= Knockapi::Internal::Type::Union && other.derefed_variants == derefed_variants
        ...
        def dump(value)
          if (target = resolve_variant(value))
            return Knockapi::Internal::Type::Converter.dump(target, value)
          end

          known_variants.each do
            target = _2.call
            return Knockapi::Internal::Type::Converter.dump(target, value) if target === value
          end
