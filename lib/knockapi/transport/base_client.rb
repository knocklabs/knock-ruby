...
module Knockapi
  module Transport
    ...
    class BaseClient
        ...
        def follow_redirect(request, status:, response_headers:)
          ...
          location =
            Kernel.then do
              ...
              raise Knockapi::Errors::APIConnectionError.new(url: url, message: message)
            end
      ...
      # @api private
      # @return [Knockapi::Transport::PooledNetRequester]
      ...
      def initialize(
        ...
        @requester = Knockapi::Transport::PooledNetRequester.new
      ...
      #
      #   @option req [Knockapi::Type::Converter, Class, nil] :model
      #
      ...
      def request(req)
        ...
        in { page: Class => page }
          ...
          Knockapi::Type::Converter.coerce(model, unwrapped)
        end
      end
